...
var nodes = [
{ name: 'Google', type: "T1" },
{ name: 'Microsoft', type: "T2" },
{ name: 'Afrihost', type: "T3"},
{ name: 'Telkom', type: "T3"},
{ name: 'MTN', type: "T3"},
{ name: 'Vodacom', type: "T3"},
{ name: 'Amazon', type: "T1"},
{ name: 'IXP' , type: "IX"}
];

var links = [{
  source: find_node('Amazon'),
  target: find_node('Microsoft'),
  desc: "10Mbps",
  type: "normal"
}, {
  source: find_node('Google'),
  target: find_node('Microsoft'),
  desc: "10Mbps",
  type: "normal"
}, {
  ...
  source: find_node('Telkom'),
  target: find_node('IXP'),
  desc: "100Mbps",
  type: "normal"
}, {
  source: find_node('MTN'),
  target: find_node('IXP'),
  desc: "100Mbps",
  type: "normal"
}, {
  source: find_node('Afrihost'),
  target: find_node('IXP'),
  desc: "Faulty",
  type: "down"
}, {
  source: find_node('Vodacom'),
  target: find_node('IXP'),
  desc: "Slow...",
  type: "overload"
}, {
  source: find_node('IXP'),
  target: find_node('Microsoft'),
  desc: "10Mbps",
  type: "normal"
}];
